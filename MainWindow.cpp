...
void MainWindow::createToolBox() {
    ...
    toolboxLayout->addWidget(createCellWidget(tr("ccvs"),":/images/ccvs.png",Component::ccvs),0,3);
    toolboxLayout->addWidget(createCellWidget(tr("cccs"),":/images/cccs.png",Component::cccs),1,3);
